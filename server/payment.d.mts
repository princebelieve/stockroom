export type PaymentPolicy = { allowWallet: boolean; allowWalletCredit: boolean; allowExtras: boolean; reasonForChange: boolean; printExtraDetails: boolean; reasons: string[] }
