...
export const { getSettings, updateSettings, queueInitialSettingsSnapshot, listProducts, createProduct, adjustStock, createSale, authenticateUser, getUserById, createSession, sessionUser, deleteSession, provisionCloudUser, changePassword, resetCashierPassword, listUsers, createUser, updateUserRole, setCashierOperationalAccess, createOwnerSetup, getOwnerMetrics, getReports, exportSalesCsv, listCustomers, createCustomer, adjustCustomerWallet, listExpenses, createExpense, listSales, listMovements, createBackup, getPendingSyncOperations, markSyncOperationsSynced, recordSyncConflicts, listSyncConflicts, resolveSyncConflict, markSyncFailure, getSyncCursor, setSyncCursor, getSyncStatus, applyRemoteOperations, createStocktake, getStocktake, updateStocktakeCount, approveStocktake } = repository
