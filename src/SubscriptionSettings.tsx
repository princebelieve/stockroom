...
type Plan = { amount: number; currency: string; days: number; reminderDays: number; freeTrialDays: number; firstReferralPercent?: number; recurringReferralPercent?: number }
