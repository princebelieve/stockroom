...
export function ProductIntake({ create, products, defaultUnit }: { create: (product: Draft) => Promise<void>; products: Product[]; defaultUnit: string }) {
