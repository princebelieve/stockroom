...
export function PaymentEvidence({ sales, money }: { sales: Sale[]; money: (amount: number) => string }) {
  ...
  return <section className="panel full-panel"><h3>Payment accountability</h3><p>Recorded amounts and cashier explanations for the loaded sales. These records do not prove bank settlement. Extras are separate from merchandise revenue.</p>
