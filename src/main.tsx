...
createRoot(document.getElementById('root')!).render(<StrictMode><><AppUpdatePrompt />{window.location.pathname === '/customer-display' ? <main className="login-screen"><section className="login-card"><h1>Customer display</h1><p>Open a new pairing link from the checkout computer?s Customer display page.</p></section></main> : <App />}</></StrictMode>)
