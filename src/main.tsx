...
function App() {
  ...
  async function importProduct(input: { name: string; barcode?: string; category?: string; unit?: string; price?: number; cost?: number; stock?: number; reorder?: number }) {
    const payload = { ...input, sku: deriveSku(input.name), barcode: input.barcode || '', category: input.category || '', unit: input.unit || 'item', price: input.price || 0, cost: input.cost || 0, stock: input.stock || 0, reorder: input.reorder || 0 }
  ...
  return <div className="app-shell">
    ...
    <main className="main-content">
      ...
      {active === 'Inventory' && <ProductIntake create={importProduct} />}
