...
The developer sets the grace period in calendar months (0–12) in the in-app plan settings. It defaults to one calendar month and is measured in UTC, clamped to the last day of shorter months. For example, one month after expiry on January 31 at noon is February 28 at noon (February 29 in leap years). At the deadline, POS and new sale requests are blocked. Renewal restores access. Inventory, reports, and sign-in remain available.
